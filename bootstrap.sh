...
export APT_REPOSITORY_TAGS=${APT_REPOSITORY_TAGS:-main extra tcp tcp-salt}
...
install_salt_formula_pkg()
{
    ...
    case $PLATFORM_FAMILY in
      debian)
          ...
          declare -a formula_services=("linux" "reclass" "salt" "openssh" "ntp" "git" "nginx" "collectd" "sensu" "heka" "sphinx" "keystone" "mysql" "grafana")
